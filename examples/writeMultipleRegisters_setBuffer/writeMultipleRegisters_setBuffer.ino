...
void loop() {
    ...
    modbus.setTransmitBuffer(0, 400);
    modbus.setTransmitBuffer(1, 500);
    esp_err_t status = modbus.writeMultipleRegisters(0x0050, 2);

    if (status == ESP_OK)
        Serial.println("Regs 0x0050-0x0051 = 400, 500");
    else
